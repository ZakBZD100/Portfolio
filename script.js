...
document.addEventListener('DOMContentLoaded', function() {
    ...
    //languagestate
    const initialLang = (languageToggle && languageToggle.getAttribute('data-lang')) ||
        (mobileLangToggle && mobileLangToggle.getAttribute('data-lang')) ||
        document.documentElement.lang || 'fr';
    let currentLang = initialLang.toLowerCase().startsWith('en') ? 'en' : 'fr';
    ...
    function applyLanguage(lang) {
        ...
        elementsWithLang.forEach(element => {
            ...
            //only update leaf translatable nodes to avoid overriding nested structures
            const hasNestedTranslatable = !!element.querySelector('[data-fr][data-en]');
    ...
    //make sure the document language and all localized texts are in sync on load
